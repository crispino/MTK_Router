...
#define ONT_LOG_DEBUG
#ifdef ONT_LOG_DEBUG
#define ONT_LOG(c...) SysLog(LOG_USER|SYS_LOG_INFO|LOGM_ONT, ##c)
#else
#define ONT_LOG(c...) SysLog(SYS_LOG_INFO|LOGM_ONT, ##c)
#endif
 ...
 */
int32_t ont_platform_time(void);
