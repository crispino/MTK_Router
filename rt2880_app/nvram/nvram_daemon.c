...
#define WPS_AP_PBC_LED_GPIO     11       // MT7628 WPS LED
#elif defined (CONFIG_PRODUCT_339AA) || defined (CONFIG_PRODUCT_339AA_JS)
#define WPS_AP_PBC_LED_GPIO     38       // MT7628 WPS LED
#elif defined (CONFIG_PRODUCT_331AA) || defined (CONFIG_PRODUCT_331AA_JS)
#define WPS_AP_PBC_LED_GPIO     11       // MT7628 WPS LED
#elif defined (CONFIG_PRODUCT_AN1301)
#define WPS_AP_PBC_LED_GPIO     11       // MT7628 WPS LED
#elif defined (CONFIG_PRODUCT_AN1302)
#define WPS_AP_PBC_LED_GPIO     11       // MT7628 WPS LED
...
//	printf("mode:%d\n",mode);
	switch (mode) {
	case WPS_LED_RESET:
		return gpioLedSet(gpio, 0, 1, 1, 1, RALINK_GPIO_LED_INFINITY);
		break;
	case WPS_LED_PROGRESS:
		return gpioLedSet(gpio, 2, 1, 1, 1, 240);
		break;
	case WPS_LED_ERROR:
		return gpioLedSet(gpio, 6, 1, 1, 1, 60);
		break;
	case WPS_LED_SESSION_OVERLAP:
		return gpioLedSet(gpio, 4, 4, 10, 5, 240);
		break;
...
static void queryWPSStatus(int signo)
{
	...
	case 34:	/* CONFIGURED */
		...
		getCurrentWscProfile(iface, wsc_value, sizeof(WSC_CONFIGURED_VALUE));
...
static void dhcpcHandler(int signo)
{
	...
	system("/sbin/qos_init.sh");
	system("/sbin/qos_custom.sh");	
#endif
...
int main(int argc,char **argv)
{
	...
	if (initGpio(18) != 0)
		exit(EXIT_FAILURE);
#elif defined (CONFIG_RALINK_MT7628)
#if defined (CONFIG_PRODUCT_340AA) || defined (CONFIG_PRODUCT_341AA) || defined (CONFIG_PRODUCT_331AA) || defined (CONFIG_PRODUCT_AN1303)
		...
		/* MT7628 reset default */
		if (initGpio(11) != 0)	// RFB-V10/V11: GPIO #45, RFB-V12: GPIO #38 
			exit(EXIT_FAILURE);
#if defined CONFIG_USER_LIGHTY && defined WSC_SUPPORT
		/* MT7628 WPS PBC */
		if (initGpio(11) != 0)	// RFB-V10/V11: GPIO #46, RFB-V12: GPIO #38
			exit(EXIT_FAILURE);
#endif
