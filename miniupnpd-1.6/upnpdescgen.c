/* $Id: //WIFI_SOC/MP/SDK_4_3_0_0/RT288x_SDK/source/user/miniupnpd-1.6/upnpdescgen.c#1 $ */
/* MiniUPnP project
...
{
	/*benj: remove the below 5 actions to enable double click for invoking web browser
	   on MS windows  */
#if 0
